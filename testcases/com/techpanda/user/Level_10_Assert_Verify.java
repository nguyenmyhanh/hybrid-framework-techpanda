...
public class Level_10_Assert_Verify extends BaseTest {
	...
	public void Login_01_Empty_Data() {
		...
		verifyEquals(loginPageObject.getErrorMessageAtEmailTextbox(), "Please enter your email");
	...
	public void Login_02_Invalid_Email() {
		...
		verifyEquals(loginPageObject.getErrorMessageAtEmailTextbox(), "Wrong email");
	...
	public void Login_03_Email_Not_Found() {
		...
		verifyEquals(loginPageObject.getErrorMessageUnsuccessfull(), "Login was unsuccessful. Please correct the errors and try again.\nNo customer account found");
