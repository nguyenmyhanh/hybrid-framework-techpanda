...
public class Level_02_Apply_BasePage_III extends BasePage {
	...
	public void TC_05_Register_Password_Less_Than_6_Chars() {
		...
		sendkeyToElement(driver, "//input[@id='Password']", "1231");

		sendkeyToElement(driver, "//input[@id='ConfirmPassword']", "1231");
	...
	public void TC_06_Register_Invalid_Confirm_Password() {
		...
		sendkeyToElement(driver, "//input[@id='Password']", "1231123123");

		sendkeyToElement(driver, "//input[@id='ConfirmPassword']", "1231123456");
