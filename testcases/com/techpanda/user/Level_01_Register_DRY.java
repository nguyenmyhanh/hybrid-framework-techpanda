...
public class Level_01_Register_DRY {
	...
	public void TC_05_Register_Password_Less_Than_6_Chars() {
		...
		driver.findElement(By.cssSelector("input#Email")).sendKeys(emailAdress);
		driver.findElement(By.cssSelector("input#Password")).sendKeys("12312");
		driver.findElement(By.cssSelector("input#ConfirmPassword")).sendKeys("12312");
	...
	public void TC_06_Register_Invalid_Confirm_Password() {
		...
		driver.findElement(By.cssSelector("input#Email")).sendKeys(emailAdress);
		driver.findElement(By.cssSelector("input#Password")).sendKeys("123123");
		driver.findElement(By.cssSelector("input#ConfirmPassword")).sendKeys("1231247");
