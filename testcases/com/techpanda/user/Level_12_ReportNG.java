...
public class Level_12_ReportNG extends BaseTest {
	...
	public void TC_02_Verify_Element_UnDdisplayed_In_Dom() {
		...
		Assert.assertTrue(loginPage.isConfirmAddressEmailTextboxDisplayes());
		...
		Assert.assertFalse(loginPage.isConfirmAddressEmailTextboxDisplayes());
	...
	public void TC_03_Verify_Element_Undisplayed_Not_In_Dom() {
		...
		Assert.assertFalse(loginPage.isConfirmAddressEmailTextboxUnDisplayes());
