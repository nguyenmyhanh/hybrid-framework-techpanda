...
// basePage.sendkeyToElement(driver, "//input[@id='Email']", emailAdress);
//
// basePage.sendkeyToElement(driver, "//input[@id='Password']", "1231");
//
// basePage.sendkeyToElement(driver, "//input[@id='ConfirmPassword']", "1231");
//
// basePage.waitForAllElementClickable(driver, "//button[@id='register-button']");
// basePage.clickToElement(driver, "//button[@id='register-button']");
...
// basePage.sendkeyToElement(driver, "//input[@id='Email']", emailAdress);
//
// basePage.sendkeyToElement(driver, "//input[@id='Password']", "1231123123");
//
// basePage.sendkeyToElement(driver, "//input[@id='ConfirmPassword']", "1231123456");
//
// basePage.waitForAllElementClickable(driver, "//button[@id='register-button']");
// basePage.clickToElement(driver, "//button[@id='register-button']");
